...
import ma.smartcity.smartcity.registration.RegistrationRequest;
import lombok.AllArgsConstructor;
import ma.smartcity.smartcity.email.EmailSender;
...
public class RegistrationService {
    ...
    public ModelAndView register(RegistrationRequest request) {
        ...
        if (!isValidEmail){
            throw new IllegalStateException("Email Not valid (format : example@email.com");
        }
        ...
        modelAndView.setViewName("email/email_sent");
        return modelAndView;
    }
    ...
    public ModelAndView confirmToken(String token) {
        ...
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("email/email_confirmed");
        return modelAndView;
//        return "confirmed";
    }
    ...
    private String buildEmail(String name, String link) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "        \n" +
                "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hi " + name + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> Thank you for registering to our SmartCity. Please click on the below link to activate your account: </p><blockquote style=\"Margin:0 0 20px 0;border-left:10px solid #b1b4b6;padding:15px 0 0.1px 15px;font-size:19px;line-height:25px\"><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> <a href=\"" + link + "\">Activate Now</a> </p></blockquote>\n Link will expire in 15 minutes. <p>See you soon</p>" +
                "        \n" +
                "      </td>\n" +
                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                "    </tr>\n" +
